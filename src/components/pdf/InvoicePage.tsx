...
const InvoicePage: FC<Props> = ({ data, pdfMode, onChange }) => {
  ...
  const handleProductLineChange = (index, field, value) => {
    const updatedProductLines = [...invoice.productLines];
    const productLine = updatedProductLines[index];

    if (field === "description") {
      productLine.description = value;
    ...
    // Update the state with the modified product lines
    setInvoice({
      ...invoice,
